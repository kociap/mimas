...
MIMAS_API Mimas_Display_Settings
mimas_get_display_settings(Mimas_Display* display);
...
//
// Parameters:
// window  - the window to be made fullscreen.
// display - the display onto which to fullscreen window.
//
MIMAS_API void mimas_fullscreen_window(Mimas_Window* window,
...
// The window is initially hidden and must be explicitly shown by the user.
// To show the window, call mimas_show_window.
//
// Parameters:
// info - parameters to use for window creation.
//
// Returns:
// A pointer to the newly created window or NULL if the function failed to create one.
//
...
// mimas_set_window_title
// Sets the title of a window.
//
// Parameters:
// window - the window whose title to change.
// title  - pointer to a null-terminated UTF-8 encoded string.
//
MIMAS_API void mimas_set_window_title(Mimas_Window* window,
                                      mimas_char8 const* title);
...
//
typedef void (*mimas_window_activate_callback)(Mimas_Window* window,
                                               mimas_i32 activated,
                                               void* user_data);
MIMAS_API void
mimas_set_window_activate_callback(Mimas_Window* window,
                                   mimas_window_activate_callback callback,
                                   void* user_data);
MIMAS_API Mimas_Callback
mimas_get_window_activate_callback(Mimas_Window* window);

typedef void (*mimas_window_resize_callback)(Mimas_Window* window, mimas_i32 w,
                                             mimas_i32 h, void* user_data);
MIMAS_API void mimas_set_window_resize_callback(Mimas_Window* window,
                                                mimas_window_resize_callback,
                                                void* user_data);
...
//
typedef void (*mimas_window_cursor_pos_callback)(Mimas_Window* window,
                                                 mimas_i32 x, mimas_i32 y,
                                                 void* user_data);
MIMAS_API void
mimas_set_window_cursor_pos_callback(Mimas_Window* window,
                                     mimas_window_cursor_pos_callback callback,
                                     void* user_data);
MIMAS_API Mimas_Callback mimas_get_cursor_pos_callback(Mimas_Window* window);

typedef void (*mimas_window_mouse_button_callback)(
  Mimas_Window* window, Mimas_Key button, Mimas_Mouse_Button_Action action,
  void* user_data);
MIMAS_API void mimas_set_window_mouse_button_callback(
  Mimas_Window* window, mimas_window_mouse_button_callback callback,
  void* user_data);
MIMAS_API Mimas_Callback
mimas_get_window_mouse_button_callback(Mimas_Window* window);
...
//
typedef void (*mimas_window_scroll_callback)(Mimas_Window* window, float d_x,
                                             float d_y, void* user_data);
MIMAS_API void mimas_set_window_scroll_callback(
  Mimas_Window* window, mimas_window_scroll_callback callback, void* user_data);
MIMAS_API Mimas_Callback mimas_get_window_scroll_callback(Mimas_Window* window);

typedef void (*mimas_window_key_callback)(Mimas_Window* window, Mimas_Key key,
                                          Mimas_Key_Action action,
                                          void* user_data);
MIMAS_API void mimas_set_window_key_callback(Mimas_Window* window,
                                             mimas_window_key_callback callback,
                                             void* user_data);
MIMAS_API Mimas_Callback mimas_get_window_key_callback(Mimas_Window* window);

typedef void (*mimas_window_char_callback)(Mimas_Window* window,
                                           mimas_char32 codepoint,
                                           void* user_data);
MIMAS_API void mimas_set_window_char_callback(
  Mimas_Window* window, mimas_window_char_callback callback, void* user_data);
MIMAS_API Mimas_Callback mimas_get_window_char_callback(Mimas_Window* window);

typedef void (*mimas_window_close_requested)(Mimas_Window* window,
                                             void* user_data);
MIMAS_API void mimas_set_window_close_requested_callback(Mimas_Window* window,
                                                         void* user_data);
MIMAS_API Mimas_Callback
mimas_get_window_close_requested_callback(Mimas_Window* window);

// Set custom hit function for the native window to define custom resize, drag, minimize, maximize and close behaviour.
//
typedef Mimas_Hittest_Result (*mimas_window_hittest)(Mimas_Window* window,
                                                     mimas_i32 cursor_x,
                                                     mimas_i32 cursor_y,
                                                     Mimas_Rect window_rect,
                                                     Mimas_Rect client_rect);
MIMAS_API void mimas_set_window_hittest(Mimas_Window* window,
                                        mimas_window_hittest callback);
MIMAS_API Mimas_Callback mimas_get_window_hittest(Mimas_Window* window);

MIMAS_API void mimas_set_window_pos(Mimas_Window* window, mimas_i32 x,
                                    mimas_i32 y);
MIMAS_API void mimas_get_window_pos(Mimas_Window* window, mimas_i32* x,
                                    mimas_i32* y);
MIMAS_API void mimas_set_window_content_pos(Mimas_Window* window, mimas_i32 x,
                                            mimas_i32 y);
MIMAS_API void mimas_get_window_content_pos(Mimas_Window* window, mimas_i32* x,
                                            mimas_i32* y);
MIMAS_API void mimas_set_window_content_size(Mimas_Window* window,
                                             mimas_i32 width, mimas_i32 height);
MIMAS_API void mimas_get_window_content_size(Mimas_Window* window,
                                             mimas_i32* width,
                                             mimas_i32* height);
...
//
MIMAS_API void mimas_clip_cursor(Mimas_Window* window,
                                 Mimas_Rect const* region);
...
MIMAS_API Mimas_Cursor*
mimas_create_standard_cursor(Mimas_Standard_Cursor cursor);
...
//
MIMAS_API Mimas_String mimas_open_file_dialog(Mimas_File_Dialog_Type type,
                                              Mimas_File_Dialog_Flags flags,
                                              Mimas_File_Filter* filters,
                                              mimas_u64 filter_count,
                                              Mimas_String_View default_path);
