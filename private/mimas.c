...
{
  Mimas_Window_List_Element* const elem =
    (Mimas_Window_List_Element*)malloc(sizeof(Mimas_Window_List_Element));
  if(!elem) {
    // TODO: Error
    return NULL;
  }
...
void mimas_set_window_activate_callback(Mimas_Window* window,
...
{
  return (Mimas_Callback){(void*)window->callbacks.window_activate,
                          window->callbacks.window_activate_data};
}

void mimas_set_window_resize_callback(Mimas_Window* window,
                                      mimas_window_resize_callback callback,
                                      void* user_data)
{
...
{
  return (Mimas_Callback){(void*)window->callbacks.window_resize,
                          window->callbacks.window_resize_data};
}

void mimas_set_window_cursor_pos_callback(
  Mimas_Window* window, mimas_window_cursor_pos_callback callback,
  void* user_data)
{
...
{
  return (Mimas_Callback){(void*)window->callbacks.cursor_pos,
                          window->callbacks.cursor_pos_data};
}

void mimas_set_window_mouse_button_callback(
...
{
  return (Mimas_Callback){(void*)window->callbacks.mouse_button,
...
{
  return (Mimas_Callback){(void*)window->callbacks.scroll,
                          window->callbacks.scroll_data};
}

void mimas_set_window_key_callback(Mimas_Window* window,
...
{
  return (Mimas_Callback){(void*)window->callbacks.key,
                          window->callbacks.key_data};
}

void mimas_set_window_char_callback(Mimas_Window* window,
                                    mimas_window_char_callback callback,
                                    void* user_data)
{
...
{
  return (Mimas_Callback){(void*)window->callbacks.character,
                          window->callbacks.character_data};
}

void mimas_set_window_hittest(Mimas_Window* window,
