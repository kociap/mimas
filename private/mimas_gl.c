...
Mimas_GL_Context* mimas_create_gl_context(mimas_i32 const version_major,
                                          mimas_i32 const version_minor,
                                          Mimas_GL_Profile const profile)
{
  return mimas_platform_create_gl_context(version_major, version_minor,
                                          profile);
}
