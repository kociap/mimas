...
mimas_bool mimas_load_wgl(HDC const hdc)
{
  ...
  if(opengl_module) {
    mimas_wglGetProcAddress =
      (PFN_wlgGetProcAddress)GetProcAddress(opengl_module, "wglGetProcAddress");
    mimas_wglCreateContext =
      (PFN_wglCreateContext)GetProcAddress(opengl_module, "wglCreateContext");
    mimas_wglDeleteContext =
      (PFN_wglDeleteContext)GetProcAddress(opengl_module, "wglDeleteContext");
    mimas_wglGetCurrentDC =
      (PFN_wglGetCurrentDC)GetProcAddress(opengl_module, "wglGetCurrentDC");
    mimas_wglGetCurrentContext = (PFN_wglGetCurrentContext)GetProcAddress(
      opengl_module, "wglGetCurrentContext");
    mimas_wglMakeCurrent =
      (PFN_wglMakeCurrent)GetProcAddress(opengl_module, "wglMakeCurrent");
    mimas_wglShareLists =
      (PFN_wglShareLists)GetProcAddress(opengl_module, "wglShareLists");
    ...
    mimas_wglGetExtensionsStringARB =
      (PFN_wglGetExtensionsStringARB)wglGetProcAddress(
        "wglGetExtensionsStringARB");
    mimas_wglCreateContextAttribsARB =
      (PFN_wglCreateContextAttribsARB)wglGetProcAddress(
        "wglCreateContextAttribsARB");
    mimas_wglGetPixelFormatAttribivARB =
      (PFN_wglGetPixelFormatAttribivARB)wglGetProcAddress(
        "wglGetPixelFormatAttribivARB");
    mimas_wglGetPixelFormatAttribfvARB =
      (PFN_wglGetPixelFormatAttribfvARB)wglGetProcAddress(
        "wglGetPixelFormatAttribfvARB");
    mimas_wglChoosePixelFormatARB =
      (PFN_wglChoosePixelFormatARB)wglGetProcAddress("wglChoosePixelFormatARB");
    mimas_wglSwapIntervalEXT =
      (PFN_wglSwapIntervalEXT)wglGetProcAddress("wglSwapIntervalEXT");
    mimas_wglGetSwapIntervalEXT =
      (PFN_wglGetSwapIntervalEXT)wglGetProcAddress("wglGetSwapIntervalEXT");
