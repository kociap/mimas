...
typedef HGLRC (*PFN_wglCreateContextAttribsARB)(HDC hDC, HGLRC hShareContext,
...
typedef BOOL(WINAPI* PFN_wglGetPixelFormatAttribivARB)(
  HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes,
  int const* piAttributes, int* piValues);
typedef BOOL(WINAPI* PFN_wglGetPixelFormatAttribfvARB)(
  HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes,
  int const* piAttributes, FLOAT* pfValues);
typedef BOOL(WINAPI* PFN_wglChoosePixelFormatARB)(
  HDC hdc, int const* piAttribIList, FLOAT const* pfAttribFList,
