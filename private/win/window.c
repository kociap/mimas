...
void mimas_platform_poll_events() {
    ...
    platform->mouse_state[MIMAS_MOUSE_BUTTON_LEFT] = GetKeyState(VK_LBUTTON);
    platform->mouse_state[MIMAS_MOUSE_BUTTON_RIGHT] = GetKeyState(VK_RBUTTON);
    platform->mouse_state[MIMAS_MOUSE_BUTTON_MIDDLE] = GetKeyState(VK_MBUTTON);
}
